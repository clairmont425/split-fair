...
const _slides = [
  _Slide(
    ...
    body: 'Finally, an app that settles the age-old question:\n"Why is Dave paying the same rent as me when his room has a window AND a closet?"\n\nSpoiler: he shouldn\'t be.',
  ...
  _Slide(
    ...
    body: 'Enter each room\'s square footage and we do the math.\n\nThe person with 80 extra square feet of personal kingdom doesn\'t get to split 50/50. That\'s not splitting fairly — that\'s just splitting in Dave\'s favor.',
